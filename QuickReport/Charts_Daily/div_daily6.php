...
<p>Legend Item 10: <br><input id="txt_legend10_6d" type="text"></input></p>
<p>Legend Item 11: <br><input id="txt_legend11_6d" type="text"></input></p>
<p>Legend Item 12: <br><input id="txt_legend12_6d" type="text"></input></p>
</div>
</div>
...
<p>Color Line 10: <br><input id="colorSelector10_6d" type="text"></input></p>
<p>Color Line 11: <br><input id="colorSelector11_6d" type="text"></input></p>
<p>Color Line 12: <br><input id="colorSelector12_6d" type="text"></input></p>
</div>
</div>
...
<p>Line Style 10: <br><select id="linestyle10_6d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 11: <br><select id="linestyle11_6d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 12: <br><select id="linestyle12_6d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Width 10: <br><select id="linewidth10_6d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 11: <br><select id="linewidth11_6d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 12: <br><select id="linewidth12_6d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
$('#colorSelector10_6d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc6d = $("#container2").highcharts();
		$('#colorSelector10_6d').css('backgroundColor', '#' + hex);
		color[10] = hex;
		acc6d.series[10].update({color: "#"+color[10]+""});
	}
});

$('#colorSelector11_6d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc6d = $("#container2").highcharts();
		$('#colorSelector11_6d').css('backgroundColor', '#' + hex);
		color[11] = hex;
		acc6d.series[11].update({color: "#"+color[11]+""});
	}
});

$('#colorSelector12_6d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc6d = $("#container2").highcharts();
		$('#colorSelector12_6d').css('backgroundColor', '#' + hex);
		color[12] = hex;
		acc6d.series[12].update({color: "#"+color[12]+""});
	}
});
...
$('#txt_legend10_6d').on('keyup mouseup', function(){
var acc6d = $("#container2").highcharts();	
if($("#txt_legend10_6d").val() != ""){
legend[10] = $("#txt_legend10_6d").val();	
acc6d.legend.allItems[10].update({name:""+legend[10]+""});
}else{
acc6d.legend.allItems[10].update({name:""+legend_old10+""});
}	
});

$('#txt_legend11_6d').on('keyup mouseup', function(){
var acc6d = $("#container2").highcharts();	
if($("#txt_legend11_6d").val() != ""){
legend[11] = $("#txt_legend11_6d").val();	
acc6d.legend.allItems[11].update({name:""+legend[11]+""});
}else{
acc6d.legend.allItems[11].update({name:""+legend_old11+""});
}	
});

$('#txt_legend12_6d').on('keyup mouseup', function(){
var acc6d = $("#container2").highcharts();	
if($("#txt_legend12_6d").val() != ""){
legend[12] = $("#txt_legend12_6d").val();	
acc6d.legend.allItems[12].update({name:""+legend[12]+""});
}else{
acc6d.legend.allItems[12].update({name:""+legend_old12+""});
}	
});
...
$('#linestyle10_6d').change(function(){
var acc6d = $("#container2").highcharts();
if($("#linestyle10_6d").val() != ""){
typeline[10] = $("#linestyle10_6d").val();
acc6d.series[10].update({dashStyle: ""+typeline[10]+""});
}else{
acc6d.series[10].update({dashStyle: "Solid"});	
}
});

$('#linestyle11_6d').change(function(){
var acc6d = $("#container2").highcharts();
if($("#linestyle11_6d").val() != ""){
typeline[11] = $("#linestyle11_6d").val();
acc6d.series[11].update({dashStyle: ""+typeline[11]+""});
}else{
acc6d.series[11].update({dashStyle: "Solid"});	
}
});

$('#linestyle12_6d').change(function(){
var acc6d = $("#container2").highcharts();
if($("#linestyle12_6d").val() != ""){
typeline[12] = $("#linestyle12_6d").val();
acc6d.series[12].update({dashStyle: ""+typeline[12]+""});
}else{
acc6d.series[12].update({dashStyle: "Solid"});	
}
});
...
$('#linewidth10_6d').change(function(){
var acc6d = $("#container2").highcharts();	
if($("#linewidth10_6d").val() != 0){
var width_line = $("#linewidth10_6d").val();
var int_width_line	= parseInt(width_line);
acc6d.series[10].update({lineWidth: int_width_line});
}else{
acc6d.series[10].update({lineWidth: 2});	
}
});

$('#linewidth11_6d').change(function(){
var acc6d = $("#container2").highcharts();	
if($("#linewidth11_6d").val() != 0){
var width_line = $("#linewidth11_6d").val();
var int_width_line	= parseInt(width_line);
acc6d.series[11].update({lineWidth: int_width_line});
}else{
acc6d.series[11].update({lineWidth: 2});	
}
});

$('#linewidth12_6d').change(function(){
var acc6d = $("#container2").highcharts();	
if($("#linewidth12_6d").val() != 0){
var width_line = $("#linewidth12_6d").val();
var int_width_line	= parseInt(width_line);
acc6d.series[12].update({lineWidth: int_width_line});
}else{
acc6d.series[12].update({lineWidth: 2});	
}
});
