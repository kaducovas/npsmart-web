...
<p>Legend Item 10: <br><input id="txt_legend10_9d" type="text"></input></p>
<p>Legend Item 11: <br><input id="txt_legend11_9d" type="text"></input></p>
<p>Legend Item 12: <br><input id="txt_legend12_9d" type="text"></input></p>
</div>
</div>
...
<p>Color Line 10: <br><input id="colorSelector10_9d" type="text"></input></p>
<p>Color Line 11: <br><input id="colorSelector11_9d" type="text"></input></p>
<p>Color Line 12: <br><input id="colorSelector12_9d" type="text"></input></p>
</div>
</div>
...
<p>Line Style 10: <br><select id="linestyle10_9d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 11: <br><select id="linestyle11_9d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 12: <br><select id="linestyle12_9d" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Width 10: <br><select id="linewidth10_9d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 11: <br><select id="linewidth11_9d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 12: <br><select id="linewidth12_9d" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
$('#colorSelector10_9d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc9d = $("#container2").highcharts();
		$('#colorSelector10_9d').css('backgroundColor', '#' + hex);
		color[10] = hex;
		acc9d.series[10].update({color: "#"+color[10]+""});
	}
});

$('#colorSelector11_9d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc9d = $("#container2").highcharts();
		$('#colorSelector11_9d').css('backgroundColor', '#' + hex);
		color[11] = hex;
		acc9d.series[11].update({color: "#"+color[11]+""});
	}
});

$('#colorSelector12_9d').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc9d = $("#container2").highcharts();
		$('#colorSelector12_9d').css('backgroundColor', '#' + hex);
		color[12] = hex;
		acc9d.series[12].update({color: "#"+color[12]+""});
	}
});
...
$('#txt_legend10_9d').on('keyup mouseup', function(){
var acc9d = $("#container2").highcharts();	
if($("#txt_legend10_9d").val() != ""){
legend[10] = $("#txt_legend10_9d").val();	
acc9d.legend.allItems[10].update({name:""+legend[10]+""});
}else{
acc9d.legend.allItems[10].update({name:""+legend_old10+""});
}	
});

$('#txt_legend11_9d').on('keyup mouseup', function(){
var acc9d = $("#container2").highcharts();	
if($("#txt_legend11_9d").val() != ""){
legend[11] = $("#txt_legend11_9d").val();	
acc9d.legend.allItems[11].update({name:""+legend[11]+""});
}else{
acc9d.legend.allItems[11].update({name:""+legend_old11+""});
}	
});

$('#txt_legend12_9d').on('keyup mouseup', function(){
var acc9d = $("#container2").highcharts();	
if($("#txt_legend12_9d").val() != ""){
legend[12] = $("#txt_legend12_9d").val();	
acc9d.legend.allItems[12].update({name:""+legend[12]+""});
}else{
acc9d.legend.allItems[12].update({name:""+legend_old12+""});
}	
});
...
$('#linestyle10_9d').change(function(){
var acc9d = $("#container2").highcharts();
if($("#linestyle10_9d").val() != ""){
typeline[10] = $("#linestyle10_9d").val();
acc9d.series[10].update({dashStyle: ""+typeline[10]+""});
}else{
acc9d.series[10].update({dashStyle: "Solid"});	
}
});

$('#linestyle11_9d').change(function(){
var acc9d = $("#container2").highcharts();
if($("#linestyle11_9d").val() != ""){
typeline[11] = $("#linestyle11_9d").val();
acc9d.series[11].update({dashStyle: ""+typeline[11]+""});
}else{
acc9d.series[11].update({dashStyle: "Solid"});	
}
});

$('#linestyle12_9d').change(function(){
var acc9d = $("#container2").highcharts();
if($("#linestyle12_9d").val() != ""){
typeline[12] = $("#linestyle12_9d").val();
acc9d.series[12].update({dashStyle: ""+typeline[12]+""});
}else{
acc9d.series[12].update({dashStyle: "Solid"});	
}
});
...
$('#linewidth10_9d').change(function(){
var acc9d = $("#container2").highcharts();	
if($("#linewidth10_9d").val() != 0){
var width_line = $("#linewidth10_9d").val();
var int_width_line	= parseInt(width_line);
acc9d.series[10].update({lineWidth: int_width_line});
}else{
acc9d.series[10].update({lineWidth: 2});	
}
});

$('#linewidth11_9d').change(function(){
var acc9d = $("#container2").highcharts();	
if($("#linewidth11_9d").val() != 0){
var width_line = $("#linewidth11_9d").val();
var int_width_line	= parseInt(width_line);
acc9d.series[11].update({lineWidth: int_width_line});
}else{
acc9d.series[11].update({lineWidth: 2});	
}
});

$('#linewidth12_9d').change(function(){
var acc9d = $("#container2").highcharts();	
if($("#linewidth12_9d").val() != 0){
var width_line = $("#linewidth12_9d").val();
var int_width_line	= parseInt(width_line);
acc9d.series[12].update({lineWidth: int_width_line});
}else{
acc9d.series[12].update({lineWidth: 2});	
}
});
