...
<p> Layout <span style="float:right; margin-top:-12px"><button id="btn_theme4w4w" class="w3-btn w3-xlarge w3-text-black"><i id="Seta_theme4w4w" class="fa fa-caret-down"></i></button></span></p>
<div id= "div_theme4w4w" style="display:none; background-color:white">
...
<p>Legend Item 10: <br><input id="txt_legend10_4w" type="text"></input></p>
<p>Legend Item 11: <br><input id="txt_legend11_4w" type="text"></input></p>
<p>Legend Item 12: <br><input id="txt_legend12_4w" type="text"></input></p>
</div>
</div>
...
<p>Color Line 10: <br><input id="colorSelector10_4w" type="text"></input></p>
<p>Color Line 11: <br><input id="colorSelector11_4w" type="text"></input></p>
<p>Color Line 12: <br><input id="colorSelector12_4w" type="text"></input></p>
</div>
</div>
...
<p>Line Style 10: <br><select id="linestyle10_4w" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 11: <br><select id="linestyle11_4w" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Line Style 12: <br><select id="linestyle12_4w" type="text">
<option value="" selected="selected">Select a type</option>
<option value="Solid">Solid</option>
<option value="ShortDash">ShortDash</option>
<option value="ShortDot">ShortDot</option>
...
<p>Width 10: <br><select id="linewidth10_4w" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 11: <br><select id="linewidth11_4w" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
<p>Width 12: <br><select id="linewidth12_4w" type="text">
<option value="" selected="selected">Select a Width</option>
<option value="1">1.0</option>
<option value="2">2.0</option>
<option value="3">3.0</option>
...
$('#colorSelector10_4w').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc4w = $("#container2").highcharts();
		$('#colorSelector10_4w').css('backgroundColor', '#' + hex);
		color[10] = hex;
		acc4w.series[10].update({color: "#"+color[10]+""});
	}
});

$('#colorSelector11_4w').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc4w = $("#container2").highcharts();
		$('#colorSelector11_4w').css('backgroundColor', '#' + hex);
		color[11] = hex;
		acc4w.series[11].update({color: "#"+color[11]+""});
	}
});

$('#colorSelector12_4w').ColorPicker({
	color: '#0000ff',
	onShow: function (colpkr) {
		$(colpkr).fadeIn(500);
		return false;
	...
	onChange: function (hsb, hex, rgb) {
		var acc4w = $("#container2").highcharts();
		$('#colorSelector12_4w').css('backgroundColor', '#' + hex);
		color[12] = hex;
		acc4w.series[12].update({color: "#"+color[12]+""});
	}
});
...
$('#txt_legend10_4w').on('keyup mouseup', function(){
var acc4w = $("#container2").highcharts();	
if($("#txt_legend10_4w").val() != ""){
legend[10] = $("#txt_legend10_4w").val();	
acc4w.legend.allItems[10].update({name:""+legend[10]+""});
}else{
acc4w.legend.allItems[10].update({name:""+legend_old10+""});
}	
});

$('#txt_legend11_4w').on('keyup mouseup', function(){
var acc4w = $("#container2").highcharts();	
if($("#txt_legend11_4w").val() != ""){
legend[11] = $("#txt_legend11_4w").val();	
acc4w.legend.allItems[11].update({name:""+legend[11]+""});
}else{
acc4w.legend.allItems[11].update({name:""+legend_old11+""});
}	
});

$('#txt_legend12_4w').on('keyup mouseup', function(){
var acc4w = $("#container2").highcharts();	
if($("#txt_legend12_4w").val() != ""){
legend[12] = $("#txt_legend12_4w").val();	
acc4w.legend.allItems[12].update({name:""+legend[12]+""});
}else{
acc4w.legend.allItems[12].update({name:""+legend_old12+""});
}	
});
...
$('#linestyle10_4w').change(function(){
var acc4w = $("#container2").highcharts();
if($("#linestyle10_4w").val() != ""){
typeline[10] = $("#linestyle10_4w").val();
acc4w.series[10].update({dashStyle: ""+typeline[10]+""});
}else{
acc4w.series[10].update({dashStyle: "Solid"});	
}
});

$('#linestyle11_4w').change(function(){
var acc4w = $("#container2").highcharts();
if($("#linestyle11_4w").val() != ""){
typeline[11] = $("#linestyle11_4w").val();
acc4w.series[11].update({dashStyle: ""+typeline[11]+""});
}else{
acc4w.series[11].update({dashStyle: "Solid"});	
}
});

$('#linestyle12_4w').change(function(){
var acc4w = $("#container2").highcharts();
if($("#linestyle12_4w").val() != ""){
typeline[12] = $("#linestyle12_4w").val();
acc4w.series[12].update({dashStyle: ""+typeline[12]+""});
}else{
acc4w.series[12].update({dashStyle: "Solid"});	
}
});
...
$('#linewidth10_4w').change(function(){
var acc4w = $("#container2").highcharts();	
if($("#linewidth10_4w").val() != 0){
var width_line = $("#linewidth10_4w").val();
var int_width_line	= parseInt(width_line);
acc4w.series[10].update({lineWidth: int_width_line});
}else{
acc4w.series[10].update({lineWidth: 2});	
}
});

$('#linewidth11_4w').change(function(){
var acc4w = $("#container2").highcharts();	
if($("#linewidth11_4w").val() != 0){
var width_line = $("#linewidth11_4w").val();
var int_width_line	= parseInt(width_line);
acc4w.series[11].update({lineWidth: int_width_line});
}else{
acc4w.series[11].update({lineWidth: 2});	
}
});

$('#linewidth12_4w').change(function(){
var acc4w = $("#container2").highcharts();	
if($("#linewidth12_4w").val() != 0){
var width_line = $("#linewidth12_4w").val();
var int_width_line	= parseInt(width_line);
acc4w.series[12].update({lineWidth: int_width_line});
}else{
acc4w.series[12].update({lineWidth: 2});	
}
});
...
$( "#btn_theme4w4w" ).click(function() {

if(vis_theme4w == true){
document.getElementById("div_theme4w4w").style.display = "none";
$( "#Seta_theme4w4w" ).attr( "class", "fa fa-caret-down");
vis_theme4w = false;	
}else if(vis_theme4w == false){	
document.getElementById("div_theme4w4w").style.display = "block";
...
$( "#Seta_theme4w4w" ).attr( "class", "fa fa-caret-up");
