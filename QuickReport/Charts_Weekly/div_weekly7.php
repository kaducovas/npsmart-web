...
<p> Layout <span style="float:right; margin-top:-12px"><button id="btn_theme7w" class="w3-btn w3-xlarge w3-text-black"><i id="Seta_theme7w" class="fa fa-caret-down"></i></button></span></p>
<div id= "div_theme7w" style="display:none; background-color:white">
...
$( "#btn_theme7w" ).click(function() {

if(vis_theme7w == true){
document.getElementById("div_theme7w").style.display = "none";
$( "#Seta_theme7w" ).attr( "class", "fa fa-caret-down");
vis_theme7w = false;	
}else if(vis_theme7w == false){	
document.getElementById("div_theme7w").style.display = "block";
...
$( "#Seta_theme7w" ).attr( "class", "fa fa-caret-up");
