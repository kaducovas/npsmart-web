...
COALESCE(acc_rrc,100) as acc_rrc, 
COALESCE(fails_acc_rrc,0) as fails_acc_rrc, 
COALESCE(eff_cs,100) as eff_cs, 
COALESCE(fails_acc_cs,0) as fails_acc_cs, 
...
COALESCE(vs_rrc_rej_nodebresunavail,0) as vs_rrc_rej_nodebresunavail
	...
	if($timeagg == "weekly"){
		...
		#$finyear = $findate->format("o");
		#$findate = "(".$finyear.",".$findate.")";
		$inidate = $findate;
		#$period = '(year,week)';
		$period = 'week';
		$time = '';
