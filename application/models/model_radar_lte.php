...
STRING_AGG(quality_ul_radar_score::text, ',' order by year,week) AS sho_overhead,
...
STRING_AGG(quality_dl_radar_score::text, ',' order by year,week) AS cpich_power_ratio,
...
;");
	...
	"SELECT year, week, 'NETWORK'::text as node, 
       ...
       quality_ul_radar_score AS sho_overhead, 
       ...
       quality_dl_radar_score AS cpich_power_ratio,
