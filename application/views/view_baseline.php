...
<table id="table_id" class="cell-border stripe compact hover" border="1 solid black" cellspacing="0" width="98%">
 ...
 for ($i = 0; $i < $count; $i++) {
	 echo "<th bgcolor='#363636'><div class='vrt'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt'><a style= 'color:WHITE' onclick='selectmobaseline(this)'>".$mo[$i]."</a></font></div></th>"; 
 }
 ?>
 			<th rowspan="1" bgcolor="#1C1C1C"><div class='vrt'><font color="#FFFFFF" style="font-family: calibri; font-size:14pt"><a style= 'color:WHITE' onclick='selectmobaseline(this)'>TOTAL</a></font></div></th>
...
if ($reportnetype == 'rnc' or $reportnetype == 'network' or $reportnetype == 'uf') {
