...
<br>
<div align="left">
<a target="_blank" class="link" href="/npsmart/output/baseline_enodeb_nok.csv">Download MML</a>
</div>
<div "width=100%">
<table id="table_id" class="cell-border stripe compact hover" border="1 solid black" cellspacing="0" width="98%">
    <thead>
        <tr>
			<th bgcolor="#363636"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">MO</font></th>
			<th style='display:none;' bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">Type</font></th>
  <?php 
		 $mos = $mos[0]->mo;
		 $mo = explode(",", $mos);	
		 $count = count($mo);
 ...
 for ($i = 0; $i < $count; $i++) {
	 echo "<th bgcolor='#363636'><div class='vrt'><font color='#FFFFFF' style='font-family: calibri; font-size:12pt'><a style= 'color:WHITE' onclick='selectmobaselineenodeb(this)'>".$mo[$i]."</a></font></div></th>"; 
 }
 ?>
 			<th rowspan="1" bgcolor="#1C1C1C"><div class='vrt'><font color="#FFFFFF" style="font-family: calibri; font-size:14pt"><a style= 'color:WHITE' onclick='selectmobaselineenodeb(this)'>TOTAL</a></font></div></th>
...
if ($reportnetype == 'region' or $reportnetype == 'network') {
