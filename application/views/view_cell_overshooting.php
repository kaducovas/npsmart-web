...
<body>
 ...
 <form name="frmCellov" id="frmCellov" method="post" action="cellov">
	
<!--<input type=text id='txtCellName' name='txtCellName' value='<?php echo $cellname; ?>' onkeypress="return runKeyPress(event)">	 -->


 <div class="ui-widget">
    <label style="color: #DD0000" for="cell">Cell: </label>
...
$(document).ready(function(){
        ...
        var s_sho = [<?php echo join(',', $sho); ?>];
        var s_users = [<?php echo join(',', $users); ?>];
