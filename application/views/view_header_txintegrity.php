...
<link rel="stylesheet" href="/npsmart/css/fixedHeader.dataTables.min.css" />
...
function selectne(obj) {
	...
	document.getElementById('reportnetype').value = 'nodeb';
	document.getElementById('reportkpi').value = reportkpi;
	document.reportopt.action = '/npsmart/umts/tx_integrity';
...
function selectshowcolumn_new(obj) {
		if(obj.innerHTML == 'KPI') {
			var table = document.getElementById('table_id');
			for (var i = 0; i <= table.rows.length; i++) {
				for (var r = 4; r < 16; r++){
					if (table.rows[i].cells[r].style.display == 'none'){
						table.rows[i].cells[r].style.display = '';
					}
					else if (table.rows[i].cells[r].style.display == ''){
						table.rows[i].cells[r].style.display = 'none';
					}
				}
			}
		}		
		
		if(obj.innerHTML == 'OMR') {
			var table = document.getElementById('table_id');
			for (var i = 0; i <= table.rows.length; i++) {
				for (var r = 17; r < 20; r++){
					if (table.rows[i].cells[r].style.display == 'none'){
...
function selectkpitriage(obj) {
	...
	else if(obj.innerHTML == 'TX Integrity') {
		document.getElementById('reportcell').value = reportcell;
...
// function selecttypetriage(obj) {
	...
	// document.getElementById('reporttypetriage').value = obj.innerHTML;	
	// document.getElementById('reportkpi').value = reportkpi;
	// document.getElementById('reportnename').value = reportnename;
	// document.getElementById('reportdate').value = reportdate;
	// document.getElementById('reportnetype').value = reportnetype;
