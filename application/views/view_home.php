...
<?php echo 	'<input id="rnc" type="text" name="rnc" value="'.(isset($nernc)?$nernc:"").'"/>';?>
	<font size="4" color="#303030"><b>Site: </b></font> 
	<input id="sitename" type="text" name="site" />
<font size="4" color="#303030"><b>Cell: </b></font> 
<?php echo 	'<input id="cellname" type="text" name="cellid" value="'.(isset($necellid)?$necellid:"").'"/>';?>
...
<?php echo 	'<input type="text" name="daterange" value="'.(isset($daterange)?$daterange:"").'"/>';?>
		<script type="text/javascript">
		// $(function() {
...
<?php	
	if(isset($kpi) && $kpi == 'Accessibility'){
	echo '<div id="content" class="borda"><div id="acc_rrc" class="chart"></div></div>';
	echo '<div id="content" class="borda"><div id="acc_hsdpa" class="chart"></div></div>';		
	echo '<div style="clear: both;"></div>';
	echo '<div id="content" class="borda"><div id="fails_rrc" class="chart"></div></div>';
	echo '<div id="content" class="borda"><div id="fails_hs" class="chart"></div></div>';
	echo '<div style="clear: both;"></div>';
	echo '<div id="content" class="borda"><div id="acc_cs" class="chart"></div></div>';
	echo '<div id="content" class="borda"><div id="acc_ps" class="chart"></div></div>';
	echo '<div style="clear: both;"></div>';
	echo '<div id="content" class="borda"><div id="fails_cs" class="chart"></div></div>';
	echo '<div id="content" class="borda"><div id="fails_ps" class="chart"></div></div>';
	echo '<div style="clear: both;"></div>';
	
	
	} elseif (isset($kpi) && $kpi == 'Traffic'){
		echo '<div id="dl_data" class="chart1"></div>';
		echo '<div id="ul_data" class="chart"></div>';
		echo '<div id="hsdpa_users" class="chart"></div>';
		echo '<div id="hsupa_users" class="chart"></div>';
	
		}	

?>			
<!--	<div id="content" class="chart_content"><div id="acc_rrc" class="chart1"></div></div>
	<div id="content" class="chart_content"><div id="acc_hsdpa" class="chart"></div></div>			
