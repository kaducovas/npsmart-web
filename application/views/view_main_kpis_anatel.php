...
<html>
	...
	<body>
		<div class="sortable1">
			<div id="content0" class="chart_content"><div id="smp_5" class="chart"></div></div>
			<div id="content1" class="chart_content"><div id="smp_7" class="chart"></div></div>		
			<div id="content2" class="chart_content"><div id="smp_8" class="chart"></div></div>			
			<div id="content3" class="chart_content"><div id="smp_9" class="chart"></div></div>
		</div>
					...
					events: {
						...
						click: function(e){
							...
							if(estado_smp_5 != false){
								if (e.shiftKey == 1) {
								smp_5.xAxis[0].options.plotLines[1].color = "red";
								smp_5.xAxis[0].options.plotLines[1].value = e.xAxis[0].value;
								smp_7.xAxis[0].options.plotLines[1].color = "red";
								smp_7.xAxis[0].options.plotLines[1].value = e.xAxis[0].value;
					...
					series: {
						...
						events: {
							...
							legendItemClick: function () {
								...
								smp_5.xAxis[0].options.plotLines[1].color = "transparent";
								smp_7.xAxis[0].options.plotLines[1].color = "transparent";
	...
	<script>
		...
		<script>
			...
			$('#export').click(function() {
				Highcharts.exportCharts([smp_5,smp_7,smp_8,smp_9]);
			});
