	...
	<table id="table_id" class="cell-border compact hover" border="1 solid black" cellspacing="0" width="100%">
		...
		echo "<thead>";
			echo "<tr>";
				...
				echo "<th bgcolor='#4F4F4F'><font color='#FFFFFF'>#RNCs</font></th>";
				echo "<th bgcolor='#4F4F4F'><font color='#FFFFFF'>#CLUSTERs</font></th>";
				echo "<th bgcolor='#4F4F4F'><font color='#FFFFFF'>#CITYs</font></th>";
				echo "<th bgcolor='#4F4F4F'><font color='#FFFFFF'>#NODEBs</font></th>";
		...
		echo "<tbody>";
			...
			foreach($no_elements as $row)
				{										
					...
					echo "<td bgcolor='#FFFFFF'><font style='font-family: calibri; font-size:12pt'>".$row->rnc_no."</font></td>";
					echo "<td bgcolor='#FFFFFF'><font style='font-family: calibri; font-size:12pt'>".$row->cluster_no."</font></td>";
					echo "<td bgcolor='#FFFFFF'><font style='font-family: calibri; font-size:12pt'>".$row->cidade_no."</font></td>";
					echo "<td bgcolor='#FFFFFF'><font style='font-family: calibri; font-size:12pt'>".$row->nodeb_no."</font></td>";
...
Highcharts.chart('column', {
    ...
    series: [{
        ...
        name: '#RNCs',
		color: '#f45b5b',
        data: [<?php echo join($rnc_no, ',') ?>],
    },{
        name: '#CLUSTERs',
        data: [<?php echo join($cluster_no, ',') ?>],
    },{
        name: '#CITYs',
        data: [<?php echo join($cidade_no, ',') ?>],
    },{
        name: '#NODEBs',
        data: [<?php echo join($nodeb_no, ',') ?>],
    },{
        name: '#CELLs',
		yAxis: 1,
