	...
	<table id="table_id" class="cell-border compact hover" border="1 solid black" cellspacing="0" width="100%">
		...
		echo "<thead>";
			echo "<tr>";
				...
				echo "<th bgcolor='#4F4F4F'><font color='#FFFFFF'>#ENODEBs</font></th>";
		...
		echo "<tbody>";
			...
			foreach($no_elements as $row)
				{										
					...
					echo "<td bgcolor='#FFFFFF'><font style='font-family: calibri; font-size:12pt'>".$row->enodeb_no."</font></td>";
