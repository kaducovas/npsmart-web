...
?>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav" id="mainMenu">
                    ...
                    <li id="menuItemwaf" class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
							<li class="disabled"><a href="/npsmart/umts/baseline_nodeb">Baseline NodeB Audit</a></li>
                            <li class="disabled"><a href="/npsmart/umts/baseline">Baseline Cell & RNC Audit</a></li>
	 ...
	 <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">GSM<span class="glyphicon glyphicon-phone pull-left" style="margin-top:2px;margin-right:4px;"></span><span class="caret"></span></a>
		<ul class="dropdown-menu" role="menu">
                              <li id="menuItemwaf"><a href="/npsmart/gsm/process_monitoring">GSM</a></li>
                              <li id="menuItemwaf"><a href="/npsmart/umts/process_monitoring">UMTS</a></li>
                              <li id="menuItemwaf"><a href="/npsmart/lte/process_monitoring">LTE</a></li>
         </ul>
     </li>
	 ...
	 <a style="text-transform: capitalize" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo $reportagg ?> <span class="glyphicon glyphicon-calendar pull-left" style="margin-top:2px;margin-right:4px;"></span><span id="caretOptions1" class="caret"></span></a>
		<ul class="dropdown-menu" role="menu">
                              ...
                              <li class="disabled" id="menuItemnqi"><a onclick='selecttimeagg(this)'>Weekly</a></li>
                              <li class="disabled" id="menuItemnqi"><a onclick='selecttimeagg(this)'>Monthly</a></li>
         </ul>
     </li>
