...
if ($this->input->post('kpi') == 'HSDPA THP'){
	$target = 400;
	$bad = "#FF0000";	
	$good = "#009900";
} elseif ($this->input->post('kpi') == 'HSUPA THP'){
	$target = 40;
	$bad = "#FF0000";	
	$good = "#009900";
...
<table id="table-sparkline" class="stripe hover compact row-border" bgcolor="#ffffff">
    <thead>
        <tr>
			...
			<th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">RNC Mean KPI</font></th>
			<th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">New RNC Mean KPI</font></th>
        </tr>
    </thead>
