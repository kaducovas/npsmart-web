...
if ($this->input->post('kpi') == 'DL THP'){
	...
	$bad = "#FF0000";	
	$good = "#009900";
} elseif ($this->input->post('kpi') == 'RTWP'){
	$target = -90;
	$good = "#FF0000";	
	$bad = "#009900";
}  
...
<table id="table-sparkline" class="stripe hover compact row-border" bgcolor="#ffffff">
    <thead>
        <tr>
			...
			<th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">Region Mean KPI</font></th>
			<th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">New Region Mean KPI</font></th>
        </tr>
    </thead>
