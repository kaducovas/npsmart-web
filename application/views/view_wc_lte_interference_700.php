...
///////////////////////////////////////////////////////////rrc/////////////////////////////////////////////	
		var interference_700 = new Highcharts.Chart({
		chart: {
				renderTo: 'wcchart1',
				alignTicks:false,
				...
				tooltip: {
					...
					///	showInLegend: false,
						...
						data: [<?php echo join($interference_700, ',') ?>]///[7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
