	<?php 
		...
		$retention_fails[] = $row->retention_fails;
		}
		#echo $cellid;
		#echo $cellname;
		#echo $node;
...
///////////////////////////////////////////////////////////Availability/////////////////////////////////////////////	
		...
		chart: {
				...
				tooltip: {
					...
					///	showInLegend: false,
						name: '4G Retention',
						data: [<?php echo join($lte_retention, ',') ?>]///[7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
						///data: JSON.parse("[" + acc_rrc + "]")
					},{
			            name: 'Retention Fails',
						type: 'column',
						...
						data: [<?php echo join($retention_fails, ',') ?>]
			        }
					]							
		});
