...
///////////////////////////////////////////////////////////Availability/////////////////////////////////////////////	
		...
		chart: {
				...
				tooltip: {
					...
					///	showInLegend: false,
						name: 'QDA HS F2H',
						data: [<?php echo join($qda_ps_f2h, ',') ?>]///[7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
						///data: JSON.parse("[" + acc_rrc + "]")
					},
					{
					///	showInLegend: false,
						name: 'QDA HS',
						data: [<?php echo join($qda_ps, ',') ?>]///[7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6]
						///data: JSON.parse("[" + acc_rrc + "]")
					}
					]							
		});
