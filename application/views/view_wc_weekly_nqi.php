...
var week = "<?php echo $this->input->post('week'); ?>";
...
<table id="table-sparkline" class="stripe hover compact row-border" bgcolor="#ffffff">
    <thead>
        <tr>
            ...
            <th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">RNC</font></th>
            ...
            <th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">Weekly Fails</font></th>
            ...
            <th bgcolor="#3C6D7A"><font color="#FFFFFF" style="font-family: calibri; font-size:12pt">Impact Per Week</font></th>
        </tr>
    </thead>
	...
	elseif(strpos($this->input->post('kpi'), '3G-Retention') !== FALSE){
		$target = 99;
			...
			#echo "<td>".()$row->impact."%</td>";
			echo "<td><font color='".($row->kpi_region_rate >= $target?$good:$bad)."'>".$row->kpi_region_rate."%</font></td>";
			echo "<td><font color='".($row->new_region_kpi >= $target?$good:$bad)."'>".$row->new_region_kpi."%</font></td>";
