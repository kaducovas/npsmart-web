...
<body>
 ...
 <form name="frmWho" id="frmWho" method="post" action="who_covers">
	
<h1>Please input coordinates of point you would like to check:</h1> <br>	
Lat: <input type=text id='txtLat' name='txtLat' maxlength="14" size="14"value="<?php echo $txtLat; ?>"> 
Lon: <input type=text id='txtLon' name='txtLon' maxlength="14" size="14" value="<?php echo $txtLon; ?>"> 
Search radius: <input type=text id='txtRadius' name='txtRadius' maxlength="4" size="4" value="<?php echo $txtRadius; ?>"> 
 
 <input type=submit value="Find who covers">
 </form>
    
<h1>Cells covering at detected location:</h1><br>
<table border=1>
<tr>
	<th>Cellname</th>
	<th>Azm</th>
	<th>Grid, m</th>
	<th>Nearest site, m</th>
	<th>PD_85, m</th>
	<th>Crossing point at, m</th>
	<th>Bins at point (R=<?php echo $txtRadius; ?>)</th>
	<th>Responsible for % of point coverage</th>
	<th>Point is in overshooting area (considering Grid)</th>
	<th>RSCP at point</th>
</tr>
<?php
